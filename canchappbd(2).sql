...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2025 at 10:55 PM
...
INSERT INTO `cancha` (`id_cancha`, `id_duenio`, `nombre`, `lugar`, `verificado`, `valoracion`) VALUES
(4, 1, 'AA', 'Montevideo 1207', 0, 0),
(5, 1, 'A', '1207', 0, 0),
(6, 3, 'A', 'Lomas De Zamora xd', 0, 0),
(7, 3, 'Hay dos A ya que', 'Andaba mal, ahora bien', 0, 0);
...
INSERT INTO `duenio` (`id_duenio`, `id_cancha`, `id_usuario`, `nombre`, `email`, `contrasena`) VALUES
(1, 0, 0, 'Duenio', 'Duenio@gmail.com', '123'),
(2, 0, 1, 'A', 'A@gmail.com', '123456'),
(3, 0, 3, 'Pe', 'Pe@gmail.com', '123');
...
--
ALTER TABLE `cancha`
  MODIFY `id_cancha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
